...
echo       ============================================================================
echo             Por favor verifique que su conexion a internet este funcionando
echo       ============================================================================
echo.
...
if %server_num% gtr !max_servers! (
	...
	echo No KMS server available, Press any key to Continue  & goto:EOF)
...
echo.
echo.                        ===========================================
echo.                             gracias por llamar a compuFacilito    
echo.                        ===========================================
echo.
echo.
exit
